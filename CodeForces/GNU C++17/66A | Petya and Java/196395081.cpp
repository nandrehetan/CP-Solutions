...
void hetu()
{
    string s;
    cin>>s;
    if (s.length()<3 || (s.length()==3 && s.compare("127")<=0))
    {
        cout<<"byte"<<endl;
    }
    else if (s.length()<5 || (s.length()==5 && s.compare("32767")<=0))
    {
        cout<<"short"<<endl;
    }
    else if (s.length()<10 || (s.length()==10 && s.compare("2147483647")<=0))
    {
        cout<<"int"<<endl;
    }
    else if (s.length()<19 || (s.length()==19 && s.compare("9223372036854775807")<=0))
    {
        cout<<"long"<<endl;
    }
    else
